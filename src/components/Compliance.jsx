            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {BADGES.map((b, i) => (
                <motion.div
                  ...
                  className="card !p-6 rounded-[24px] flex flex-col gap-3 cursor-pointer bg-[#080808] border-white/[0.05] hover:border-white/20 transition-all shadow-[0_0_0_1px_rgba(255,255,255,0.08),0_0_30px_rgba(255,255,255,0.03)] hover:shadow-[0_0_0_1px_rgba(255,255,255,0.15),0_0_50px_rgba(255,255,255,0.05)]"
                >
          ...
          <div className="w-full lg:w-[55%] flex flex-col gap-6">
            {INSIGHTS.map((item, i) => (
              <motion.div
                ...
                whileHover="hover"
                variants={variants.cardHover}
                className="group card p-6 md:p-10 lg:p-12 rounded-[40px] relative overflow-hidden cursor-pointer bg-[#080808] border-white/[0.05] hover:border-white/20 transition-all duration-500 shadow-[0_0_0_1px_rgba(255,255,255,0.08),0_0_30px_rgba(255,255,255,0.03)] hover:shadow-[0_0_0_1px_rgba(255,255,255,0.15),0_0_50px_rgba(255,255,255,0.05)]"
              >

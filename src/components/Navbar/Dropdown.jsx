    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute top-full left-1/2 -translate-x-1/2 mt-4 w-[600px] bg-white rounded-3xl shadow-[0_30px_60px_rgba(0,0,0,0.12)] border border-gray-100 p-7 z-50 overflow-hidden"
        >

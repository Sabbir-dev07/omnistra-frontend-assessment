...
/**
 * 1:1 Nav Link (Refactored from definitive styles).
 */
export const NavLink = ({ label, hasDropdown = false, isActive = false, onEnter, onLeave }) => {
  return (
    ...
    >
      <div className="c-nav_link flex items-center gap-[8px] cursor-pointer relative py-2">
        {/* Definitive Dashed Divider - using #364153 from styles */}
        <div className="c-nav-link-divider w-[301px] h-[6px] absolute -bottom-[2px] left-1/2 -translate-x-1/2 pointer-events-none opacity-0 group-hover:opacity-10 transition-opacity duration-250">
        ...
        {/* Link Text - Precise typography from styles */}
        <span className="c-text-4 text-[0.875rem] font-[500] text-[#030303] uppercase tracking-[0.05em] transition-colors group-hover:text-[#3448ff] leading-[1.2]">
          {label}
        </span>

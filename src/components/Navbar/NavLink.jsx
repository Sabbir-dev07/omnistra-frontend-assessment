...
/**
 * 1:1 Nav Link (Refactored for Safety & Visibility).
 */
  ...
  return (
    ...
    >
      <div className="c-nav_link flex items-center gap-[0.5em] cursor-pointer relative py-2">
        {/* Definitive Dashed Divider - using production grey */}
        ...
        {/* Link Text - Precise typography with safe fallbacks */}
        <span className="c-text-4 text-[0.875rem] font-medium text-[#030303] uppercase tracking-[0.05em] transition-colors group-hover:text-[#3448ff] leading-[1.2]">
          {label}
        </span>
